package com.zytc.yc.spark.analyse.authlog
...
/**
  * @author LTong
  * @date 2019-06-21 下午 5:41
  */
//白名单  关键对象授权异常
object KeyObject {
    def key(config: Config, streamData: InputDStream[ConsumerRecord[String, String]]): Unit = {
        //从数据库中取出离职的人
        ...
        json.transform(x => {
            ...
            .map(x => {
                ...
                var isViolations = 0
                if (x._2._2 == 3 && x._2._1.get._11.length > 0) isViolations = 1
                //获取当前人的离职状态
